...
<form class="form-horizontal" id="material-del-form" action="material.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-8 col-sm-offset-2">
        <button id="material-delete-submit" data-form="#material-del-form" data-datatable="#product-product-list" class="btn btn-danger" name="submit" data-loading-text="Deleting...">

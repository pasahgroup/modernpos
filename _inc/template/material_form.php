...
<form id="product-update-form" class="form-horizontal" action="material.php" method="post">
        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
          ...
          <div class="form-group">
            <label for="p_type" class="col-sm-3 control-label">
              <?php echo trans('label_material_type'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
          ...
          <div ng-show="showPurchasePrice" class="form-group">
            <label for="purchase_price" class="col-sm-3 control-label">
              <?php echo trans('label_material_cost'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
          ...
          <div class="form-group">
            <label for="sell_price" class="col-sm-3 control-label">
              <?php echo trans('label_material_price'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
          ...
          <div class="form-group">
            <label for="taxrate_id" class="col-sm-3 control-label">
              <?php echo trans('label_material_tax'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">

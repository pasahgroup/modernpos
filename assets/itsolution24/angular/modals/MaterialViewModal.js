    ...
    return function(material) {
       var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                            "<button ng-click=\"closeMaterialViewModal();\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>" +
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                .then(function(response, status, headers, config) {
                    ...
                    .then(function() {
                        $scope.closeMaterialViewModal();
                    });
                });

                // Close modal
                $scope.closeMaterialViewModal = function () {

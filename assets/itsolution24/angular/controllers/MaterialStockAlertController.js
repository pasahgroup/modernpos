window.angularApp.controller("MaterialStockAlertController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/material.php?stock_query=1",
        "fixedHeader": true,
        "order": [[ 0, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "aoColumns": [
            {data : "p_id"},
            {
                ...
                "mRender": function (data, type, row) {
                    return "<a href=\"material_details.php?p_id=" + row['p_id'] + "&p_name=" + row['p_name'] + "\">" + row['p_name'] + "</a";
                }
            },
            {data : "supplier"},

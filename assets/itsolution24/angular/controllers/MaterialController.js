window.angularApp.controller("MaterialController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
    ...
    dt.dataTable({
        ...
        "columnDefs": [
            ...
            { 
                ...
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(1)").html());
                }
            },
            { 
                "targets": [2],
            ...
            { 
                "targets": [3],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(3)").html());
                }
            },
            { 
                "targets": [4],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(4)").html());
                }
            },
            { 
                "targets": [5],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(5)").html());
                }
            },
            { 
                "targets": [6],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(6)").html());
                }
            },
            { 
                "targets": [7],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(7)").html());
                }
            },
            { 
                "targets": [8],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(8)").html());
                }
            },
            { 
                "targets": [9],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(9)").html());
                }
            },
            { 
                "targets": [10],
            ...
            { 
                "targets": [12],
                'createdCell':  function (td, cellData, rowData, row, col) {
                   $(td).attr('data-title', $("#material-material-list thead tr th:eq(12)").html());
                }
            },
        ],
        "aoColumns": [
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Materials",
                exportOptions: {
                    columns: [printColumns]
                }
            },

              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li>
                    ...
                    <li>
                      <a href="material_purchase.php?type=all_invoice">
                    ...
                    <li>
                      <a href="material_purchase.php?type=all_due">
                        <?php echo trans('button_all_due_invoice'); ?>
                      </a>
                    </li>
                    <li>
                      <a href="material_purchase.php?type=paid">
                        <?php echo trans('button_paid_invoice'); ?>
                      </a>
                    </li>
                    <li>
                      <a href="material_purchase.php?type=inactive">

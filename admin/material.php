	...
	<section class="content">
	    ...
	    <div class="box box-info<?php echo create_box_state(); ?>">
	        <div class="box-header with-border">
				<h3 class="box-title">
					<span class="fa fa-fw fa-plus"></span> <?php echo sprintf(trans('text_add_new'), trans('text_material')); ?>
				</h3>
			    ...
			    <div class="col-xs-12">
			        <div class="box box-success">
				        <div class="box-header">
				            <h3 class="box-title">
				            	<?php echo sprintf(trans('text_view_all'), trans('text_material')); ?>	
				            </h3>
				            ...
				            <div class="box-tools pull-right">
				               ...
				               <?php include('../_inc/template/partials/product_filter.php'); ?>
					            ...
					            <!-- Trash Box -->
				                <div class="btn-group">
					                <a type="button" class="btn btn-danger" href="material.php?location=trash">
						...
						<div class="box-body">
							<div class="table-responsive">
								...
								?>  
								<table id="material-material-list" class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>" data-print-columns="<?php echo $print_columns;?>">
								    <thead>
								        <tr class="bg-gray">

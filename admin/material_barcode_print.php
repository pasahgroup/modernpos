...
// Add Script
$document->addScript('../assets/itsolution24/angular/controllers/BarcodeMaterialPrintController.js');
...
<div class="content-wrapper" ng-controller="BarcodeMaterialPrintController">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <?php if (isset($request->get['box_state']) && $request->get['box_state']=='open'): ?>
          <a href="material_barcode_print.php"><?php echo trans('text_barcode_title'); ?></a>  
        <?php else: ?>
          <?php echo trans('text_barcode_title'); ?>  
        <?php endif; ?>
      </li>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-success">
          ...
          <div class='box-body'> 
            <form id="form-barcode-generate" class="form-horizontal" action="material_barcode_print.php#barcode-con" method="post">
              <div class="well well-sm">
                <div class="well well-sm bg-gray r-50">
                  <div class="form-group mb-0">
                    <label for="add_item" class="col-sm-3 control-label">
                      <?php echo trans('add label_material'); ?>
                    </label>
                    <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                      <table id="product-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          ...
                          foreach ($request->post['products'] as $item): $product = get_the_material($item['item_id']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3 text-center">            
                    <a href="material_barcode_print.php"  class="btn btn-danger btn-block">
            ...
            <div id="barcode-con">
              ...
              if(isset($request->post['products'])):
                ...
                if (!$per_page) {
                  redirect(root_url() . '/admin/material_barcode_print.php');
                }
                $page_layout = '';
                switch ($per_page) {
                  case '10':
                ...
                ?>
                  ...
                  <div class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-warning" onClick="window.printContent('barcode-con', {title:'<?php echo trans('text_material_barcode_print');?>',screenSize:'fullScreen', cssLink:'<link type=\'text/css\' href=\'../assets/itsolution24/css/barcode.css\' type=\'text/css\' rel=\'stylesheet\'>'});"><span class="fa fa-print"></span> <?php echo trans('button_print');?></button>
                    </div>
                  </div>

                  <div class="barcode barcode<?php echo $page_layout;?>">
                  <?php $inc=1;foreach ($request->post['products'] as $prod): $product = get_the_material($prod['item_id']);
